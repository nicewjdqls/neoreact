...
function StatTotalMonitor() {
  ...
  const addLog = () => {
    ...
    const newLog = {
      ...
      delay: Math.floor(Math.random() * 500), // 처리시간(ms)
      rawTime: now
    };
    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          <h2 className="text-xl font-bold text-gray-900">토탈 실시간 로그 상세조회</h2>
        </div>
              ...
              <table className="w-full">
                <thead className="bg-gray-50 sticky top-0 z-10">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-center text-sm font-semibold text-gray-600 border-b border-gray-200">서비스</th>
                    ...
                    <th className="px-4 py-3 text-center text-sm font-semibold text-gray-600 border-b border-gray-200">노드</th>
                    <th className="px-4 py-3 text-center text-sm font-semibold text-gray-600 border-b border-gray-200">사용자ID</th>
                    <th className="px-4 py-3 text-center text-sm font-semibold text-gray-600 border-b border-gray-200">클라이언트 IP</th>
                    <th className="px-4 py-3 text-center text-sm font-semibold text-gray-600 border-b border-gray-200">서비스 URL</th>
                    <th className="px-4 py-3 text-center text-sm font-semibold text-gray-600 border-b border-gray-200">처리시간(ms)</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200">
                  {filteredLogs.map(log => (
                    <tr key={log.id} className="hover:bg-gray-50">
                      <td className="px-4 py-2 text-center text-sm text-gray-900">{log.timestamp}</td>
                      ...
                      <td className="px-4 py-2 text-center text-sm font-mono text-gray-900">{log.node}</td>
                      <td className="px-4 py-2 text-center text-sm font-mono text-gray-900">{log.userId}</td>
                      <td className="px-4 py-2 text-center text-sm font-mono text-gray-900">{log.clientIp}</td>
