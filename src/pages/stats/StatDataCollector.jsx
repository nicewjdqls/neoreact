    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          <h2 className="text-xl font-bold text-gray-900">데이터 수집 현황 상세조회</h2>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end mb-4">
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-600 mb-1">수집 유형</label>
              <select
            ...
            <div className="md:col-span-2">
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl hover:from-indigo-600 hover:to-purple-700 shadow-sm transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
                ...
                {isSearchMode && (
                  <button
                    ...
                    className="px-3 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-xl hover:bg-gray-200 transition-all duration-200"
                    title="실시간 모드로 돌아가기"
                  >
                    실시간
                  </button>
        ...
        <div className="flex justify-between items-center">
          <span className="text-sm text-gray-600">
            ...
            {isSearchMode && <span className="ml-2 text-blue-600 font-medium">(필터 적용됨)</span>}
          </span>
          {!isSearchMode && (
              ...
              <table className="w-full">
                <thead className="bg-gray-50 sticky top-0 z-10">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-center text-sm font-semibold text-gray-600 border-b border-gray-200">수집ID</th>
                    <th className="px-4 py-3 text-center text-sm font-semibold text-gray-600 border-b border-gray-200">데이터 소스명</th>
                    <th className="px-4 py-3 text-center text-sm font-semibold text-gray-600 border-b border-gray-200">수집 유형</th>
                    <th className="px-4 py-3 text-center text-sm font-semibold text-gray-600 border-b border-gray-200">학습모델명</th>
                    <th className="px-4 py-3 text-center text-sm font-semibold text-gray-600 border-b border-gray-200">상태</th>
                    <th className="px-4 py-3 text-center text-sm font-semibold text-gray-600 border-b border-gray-200">처리 건수</th>
                    <th className="px-4 py-3 text-center text-sm font-semibold text-gray-600 border-b border-gray-200">소요 시간</th>
                ...
                <tbody className="divide-y divide-gray-200">
                  {filteredCollects.map(collect => (
                    <tr key={collect.id} className="hover:bg-gray-50">
                      <td className="px-4 py-2 text-center text-sm text-gray-700">{collect.startTs}</td>
                      <td className="px-4 py-2 text-center text-sm text-gray-700">{collect.endTs}</td>
                      <td className="px-4 py-2 text-center text-sm font-mono text-gray-900">{collect.collectId}</td>
                      <td className="px-4 py-2 text-center text-sm font-medium text-gray-900">{collect.source}</td>
                      <td className="px-4 py-2 text-center">
                        <span className="inline-block px-2 py-1 text-xs font-medium bg-gray-100 text-gray-800 rounded-full">
                          {collect.type}
                        </span>
                      </td>
                      <td className="px-4 py-2 text-center text-sm text-gray-700">{collect.model}</td>
                      <td className="px-4 py-2 text-center">
                        <span className={`inline-block px-2 py-1 text-xs font-medium rounded-full ${getStatusBadgeClass(collect.status)}`}>
                          {collect.status}
                        </span>
                      </td>
                      ...
                      <td className="px-4 py-2 text-center text-sm text-gray-700">{collect.time}ms</td>
                      <td className="px-4 py-2 text-sm text-gray-700">{collect.message}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ) : (
              <div className="flex flex-column items-center justify-center py-16 px-6">
